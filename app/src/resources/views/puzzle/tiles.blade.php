...
<form id="store-form" method="post" action="{{ url('tiles/store') }}" style="display:none;">
    @csrf
...
<form id="update-form" method="post" action="{{ url('tiles/update') }}" style="display:none;">
    @csrf
    <input type="hidden" name="first_access" value="1">
    <input type="hidden" name="csrf" value="{{ $request }}">
</form>
...
<form id="delete-form" method="post" action="{{ url('tiles/delete') }}" style="display:none;">
    @csrf
    <input type="hidden" name="first_access" value="1">
    <input type="hidden" name="csrf" value="{{ $request }}">
</form>
